...
package body Bit_Files is
   ...
   procedure Open(File : in out File_Type; Mode : in File_Mode; Name : String) is
   ...
   begin
      ...
      -- Extract a bit.
      if (File.Bit_Buffer and Interfaces.Shift_Left(Interfaces.Unsigned_8'(1), File.Bit_Index)) /= 0 then
         Bit := 1;
      else
         Bit := 0;
      end if;
